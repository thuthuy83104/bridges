...
//		}
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$item_output .= $args->link_before.'<span class="w-nav-icon"><i class="fa fa-star"></i></span><span class="w-nav-title">'. apply_filters( 'the_title', $item->title, $item->ID ) .'</span><span class="w-nav-arrow"></span>'. $args->link_after;
		$item_output .= '</a>';
